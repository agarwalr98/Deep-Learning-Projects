...
if not os.path.exists('./dc_img'):
    os.mkdir('./dc_img')
if not os.path.exists('./dc_img/combined_image_with_blackCOLOR'):
    os.mkdir('./dc_img/combined_image_with_blackCOLOR')
...
for epoch in range(num_epochs):
  ...
  #  ===================log========================
    ...
    save_image(pic,'./dc_img/combined_image_with_blackCOLOR/image_{}.png'.format(epoch))
